...
function ClientFormInstance({handlerForward,handlerPrevious,editorMode}:TransitionalComponent) {
  ...
  return (
    <div className="bg-secondary-color p-9 rounded-lg w-full max-w-[30rem] flex flex-col items-center gap-4">
      ...
      <form onSubmit={(e) => e.preventDefault()} className="flex flex-col gap-4 w-[90%]">
        <ClientInput label="Votre nom" />
        <ClientInput label="Votre email" />
        <PhoneInput value="" onChange={() => 0} label="Numéro de téléphone" />
